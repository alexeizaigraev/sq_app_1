...
def edit_show():
    ...
    if key in get_terminals_list():
        ...
        try:
            trms = get_term_by_serial_hvost(key)
            key = trms[0]
            data = get_one_term_data(key)[0]
            state = 'serial'
        except:
    ...
    try:
        ...
        if state == 'term':
            ...
            trm_list = ' '.join(trms)
            text_info.set(f'{len(trms)=} {trm_list}')
...
tk.Button(text="bottom", bg='cyan', fg='lightblue').grid(row=22, column=4)
tk.Button(text="fringl_1", bg='cyan', fg='lightblue').grid(row=18, column=4)
tk.Button(text="fringl_2", bg='cyan', fg='lightblue').grid(row=21, column=4)

button_mk_dep = tk.Button(text="отделение", command=mk_dep, bg='cyan', fg='blue')
...
label_termial = tk.Label(text='term', font='Verdana 18', bg='cyan', fg='darkblue')\
...
label_department = tk.Label(text='dep', font='Verdana 18', bg='cyan', fg='darkblue' )\
    .grid(row=4, column=0, sticky=E)
entry_department = tk.Entry(width=WIGHT_ENTRY, font=(font_style, font_size), fg='darkmagenta', bg='lightcyan', textvariable=text_department)\
    .grid(row=4, column=1, columnspan=1, sticky=E+W)
    
text_model = tk.StringVar()
label_model = tk.Label(text='model', font='Verdana 18', bg='cyan', fg='darkblue')\
    .grid(row=5, column=0, sticky=E)
entry_model = tk.Entry(width=WIGHT_ENTRY, font=(font_style, font_size), fg='darkmagenta', bg='lightcyan', textvariable=text_model)\
    .grid(row=5, column=1, columnspan=1, sticky=E+W)

text_serial_number = tk.StringVar()
label_serial_number = tk.Label(text='serial', font='Verdana 18', bg='cyan', fg='darkblue')\
    .grid(row=6, column=0, sticky=E)
entry_serial_number = tk.Entry(width=WIGHT_ENTRY, font=(font_style, font_size), fg='darkmagenta', bg='lightcyan', textvariable=text_serial_number)\
    .grid(row=6, column=1, columnspan=1, sticky=E+W) 

text_date_manufacture = tk.StringVar()
label_date_manufacture = tk.Label(text='manuf', font='Verdana 18', bg='cyan', fg='darkblue')\
    .grid(row=7, column=0, sticky=E)
entry_date_manufacture = tk.Entry(width=WIGHT_ENTRY, font=(font_style, font_size), fg='darkmagenta', bg='lightcyan', textvariable=text_date_manufacture)\
    .grid(row=7, column=1, columnspan=1, sticky=E+W) 

text_soft = tk.StringVar()
label_soft = tk.Label(text='soft', font='Verdana 18', bg='cyan', fg='darkblue')\
    .grid(row=8, column=0, sticky=E)
entry_soft = tk.Entry(width=WIGHT_ENTRY, font=(font_style, font_size), fg='darkmagenta', bg='lightcyan', textvariable=text_soft)\
    .grid(row=8, column=1, columnspan=1, sticky=E+W) 

text_producer = tk.StringVar()
label_producer = tk.Label(text='producer', font='Verdana 18', bg='cyan', fg='darkblue')\
    .grid(row=9, column=0, sticky=E)
entry_producer = tk.Entry(width=WIGHT_ENTRY, font=(font_style, font_size), fg='darkmagenta', bg='lightcyan', textvariable=text_producer)\
    .grid(row=9, column=1, columnspan=1, sticky=E+W) 

text_rne_rro = tk.StringVar()
label_rne_rro = tk.Label(text='rne_rro', font='Verdana 18', bg='cyan', fg='darkblue')\
    .grid(row=10, column=0, sticky=E)
entry_rne_rro = tk.Entry(width=WIGHT_ENTRY, font=(font_style, font_size), fg='darkmagenta', bg='lightcyan', textvariable=text_rne_rro)\
    .grid(row=10, column=1, columnspan=1, sticky=E+W) 

text_sealing = tk.StringVar()
label_sealing = tk.Label(text='sealing', font='Verdana 18', bg='cyan', fg='darkblue')\
    .grid(row=11, column=0, sticky=E)
entry_sealing = tk.Entry(width=WIGHT_ENTRY, font=(font_style, font_size), fg='darkmagenta', bg='lightcyan', textvariable=text_sealing)\
    .grid(row=11, column=1, columnspan=1, sticky=E+W) 

text_fiscal_number = tk.StringVar()
label_fiscal_number = tk.Label(text='fiscal', font='Verdana 18', bg='cyan', fg='darkblue')\
    .grid(row=12, column=0, sticky=E)
entry_fiscal_number = tk.Entry(width=WIGHT_ENTRY, font=(font_style, font_size), fg='darkmagenta', bg='lightcyan', textvariable=text_fiscal_number)\
    .grid(row=12, column=1, columnspan=1, sticky=E+W) 

text_oro_serial = tk.StringVar()
label_oro_serial = tk.Label(text='oro_serial', font='Verdana 18', bg='cyan', fg='darkblue')\
    .grid(row=13, column=0, sticky=E)
entry_oro_serial = tk.Entry(width=WIGHT_ENTRY, font=(font_style, font_size), fg='darkmagenta', bg='lightcyan', textvariable=text_oro_serial)\
    .grid(row=13, column=1, columnspan=1, sticky=E+W) 

text_oro_number = tk.StringVar()
label_status = tk.Label(text='oro_num', font='Verdana 18', bg='cyan', fg='darkblue')\
    .grid(row=14, column=0, sticky=E)
entry_oro_number = tk.Entry(width=WIGHT_ENTRY, font=(font_style, font_size), fg='darkmagenta', bg='lightcyan', textvariable=text_oro_number)\
    .grid(row=14, column=1, columnspan=1, sticky=E+W) 

text_ticket_serial = tk.StringVar()
label_register = tk.Label(text='tik_serial', font='Verdana 18', bg='cyan', fg='darkblue')\
    .grid(row=15, column=0, sticky=E)
entry_ticket_serial = tk.Entry(width=WIGHT_ENTRY, font=(font_style, font_size), fg='darkmagenta', bg='lightcyan', textvariable=text_ticket_serial)\
    .grid(row=15, column=1, columnspan=1, sticky=E+W) 

text_ticket_1sheet = tk.StringVar()
label_ticket_1sheet = tk.Label(text='tik_1sheet', font='Verdana 18', bg='cyan', fg='darkblue')\
    .grid(row=16, column=0, sticky=E)
entry_ticket_1sheet = tk.Entry(width=WIGHT_ENTRY, font=(font_style, font_size), fg='darkmagenta', bg='lightcyan', textvariable=text_ticket_1sheet)\
    .grid(row=16, column=1, columnspan=1, sticky=E+W) 

text_ticket_number = tk.StringVar()
label_ticket_number = tk.Label(text='tik_num', font='Verdana 18', bg='cyan', fg='darkblue')\
    .grid(row=17, column=0, sticky=E)
entry_ticket_number = tk.Entry(width=WIGHT_ENTRY, font=(font_style, font_size), fg='darkmagenta', bg='lightcyan', textvariable=text_ticket_number)\
    .grid(row=17, column=1, columnspan=1, sticky=E+W) 

#______________________________________

text_sending = tk.StringVar()
label_sending = tk.Label(text='sending', font='Verdana 18', bg='cyan', fg='darkblue')\
    .grid(row=3, column=2, sticky=E)
entry_sending = tk.Entry(width=WIGHT_ENTRY, font=(font_style, font_size), fg='darkmagenta', bg='lightcyan', textvariable=text_sending)\
    .grid(row=3, column=3, columnspan=1, sticky=E+W) 

text_books_arhiv = tk.StringVar()
label_books_arhiv = tk.Label(text='book_arh', font='Verdana 18', bg='cyan', fg='darkblue')\
    .grid(row=4, column=2, sticky=E)
entry_books_arhiv = tk.Entry(width=WIGHT_ENTRY, font=(font_style, font_size), fg='darkmagenta', bg='lightcyan', textvariable=text_books_arhiv)\
    .grid(row=4, column=3, columnspan=1, sticky=E+W) 

text_tickets_arhiv = tk.StringVar()
label_tickets_arhiv = tk.Label(text='tik_arh', font='Verdana 18', bg='cyan', fg='darkblue')\
    .grid(row=5, column=2, sticky=E)
entry_tickets_arhiv = tk.Entry(width=WIGHT_ENTRY, font=(font_style, font_size), fg='darkmagenta', bg='lightcyan', textvariable=text_tickets_arhiv)\
    .grid(row=5, column=3, columnspan=1, sticky=E+W) 

text_to_rro = tk.StringVar()
label_to_rro = tk.Label(text='to_rro', font='Verdana 18', bg='cyan', fg='darkblue')\
    .grid(row=6, column=2, sticky=E)
entry_to_rro = tk.Entry(width=WIGHT_ENTRY, font=(font_style, font_size), fg='darkmagenta', bg='lightcyan', textvariable=text_to_rro)\
    .grid(row=6, column=3, columnspan=1, sticky=E+W) 

text_owner_rro = tk.StringVar()
label_owner_rro = tk.Label(text='owner', font='Verdana 18', bg='cyan', fg='darkblue')\
    .grid(row=7, column=2, sticky=E)
entry_owner_rro = tk.Entry(width=WIGHT_ENTRY, font=(font_style, font_size), fg='darkmagenta', bg='lightcyan', textvariable=text_owner_rro)\
...
entry_register = tk.Entry(width=WIGHT_ENTRY, font=(font_style, font_size), fg='darkmagenta', bg='lightcyan', textvariable=text_register)\
    .grid(row=8, column=3, columnspan=1, sticky=E+W) 

text_koatu = tk.StringVar()
label_koatu = tk.Label(text='_koatu_', font='Verdana 18', bg='cyan', fg='darkblue')\
    .grid(row=15, column=2, sticky=E)
entry_koatu = tk.Entry(width=WIGHT_ENTRY, font=(font_style, font_size), fg='blue', bg='lightcyan', textvariable=text_koatu)\
    .grid(row=15, column=3, columnspan=1, sticky=E+W) 

text_tax_id = tk.StringVar()
label_tax_id = tk.Label(text='_tax_id_', font='Verdana 18', bg='cyan', fg='darkblue')\
    .grid(row=16, column=2, sticky=E)
entry_tax_id = tk.Entry(width=WIGHT_ENTRY, font=(font_style, font_size), fg='blue', bg='lightcyan', textvariable=text_tax_id)\
    .grid(row=16, column=3, columnspan=1, sticky=E+W) 


text_koatu2 = tk.StringVar()
label_koatu2 = tk.Label(text='_koatu2_', font='Verdana 18', bg='cyan', fg='darkblue')\
    .grid(row=17, column=2 ,sticky=E)
entry_koatu = tk.Entry(width=WIGHT_ENTRY, font=(font_style, font_size), fg='blue', bg='lightcyan', textvariable=text_koatu2)\
...
entry_address = tk.Entry(width=WIGHT_ENTRY, font=(font_style, font_size), fg='blue', bg='lightcyan', textvariable=text_address)\
    .grid(row=19, column=0, columnspan=8, sticky=E+W) 

text_finish = tk.StringVar()
label_finish = tk.Label(text='finish', font='Verdana 18', bg='cyan', fg='darkblue')\
    .grid(row=9, column=2, sticky=E)
entry_finish = tk.Entry(width=WIGHT_ENTRY, font=(font_style, font_size), fg='darkmagenta', bg='lightcyan', textvariable=text_finish)\
...
label_combo_soft = tk.Label(text='soft', font='Verdana 18', bg='cyan', fg='darkblue')\
...
label_combo_owner = tk.Label(text='owner', font='Verdana 18', bg='cyan', fg='darkblue')\
...
label_combo_seal = tk.Label(text='sealing', font='Verdana 18', bg='cyan', fg='darkblue')\

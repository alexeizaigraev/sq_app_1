...
class Win(WinFunc):
    ...
    def win_main(self):
        ...
        some_menu_data = [
            ...
            ["Активные кассы", self.some_activ_term],
            ["Нерабочие отделения", self.some_no_work],
        ]
        ...
        self.menu_add(self.refresh_memu, refresh_menu_data)
        ...
        actual_menu_data = [
            ["Анализ терминалы", self.actual_analis_term],
        ...
        self.folders = comon_data_list(3)

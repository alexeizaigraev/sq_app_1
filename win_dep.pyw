...
#__________________________________
        ...
        self.label_department = tk.Label(text='department', font='Verdana 18', bg='cyan', fg='darkblue' )\
        ...
        self.label_region = tk.Label(text='region', font='Verdana 18', bg='cyan', fg='darkblue')\
            .grid(row=3, column=0, sticky=E)
        self.entry_region = tk.Entry(width=self.WIGHT_ENTRY, font=(self.font_style, self.font_size), textvariable=self.text_region, fg='darkmagenta', bg='lightcyan')\
            .grid(row=3, column=1, columnspan=1, sticky=E+W)
            
        self.text_district_region = tk.StringVar()
        self.label_district_region = tk.Label(text='district_region', font='Verdana 18', bg='cyan', fg='darkblue')\
            .grid(row=4, column=0, sticky=E)
        self.entry_district_region = tk.Entry(width=self.WIGHT_ENTRY, font=(self.font_style, self.font_size), textvariable=self.text_district_region, fg='darkmagenta', bg='lightcyan')\
            .grid(row=4, column=1, columnspan=1, sticky=E+W)

        self.text_district_city = tk.StringVar()
        self.label_district_city = tk.Label(text='district_city', font='Verdana 18', bg='cyan', fg='darkblue')\
            .grid(row=5, column=0, sticky=E)
        self.entry_district_city = tk.Entry(width=self.WIGHT_ENTRY, font=(self.font_style, self.font_size), textvariable=self.text_district_city, fg='darkmagenta', bg='lightcyan')\
            .grid(row=5, column=1, columnspan=1, sticky=E+W) 

        self.text_city_type = tk.StringVar()
        self.label_city_type = tk.Label(text='city_type', font='Verdana 18', bg='cyan', fg='darkblue')\
            .grid(row=6, column=0, sticky=E)
        self.entry_city_type = tk.Entry(width=self.WIGHT_ENTRY, font=(self.font_style, self.font_size), textvariable=self.text_city_type, fg='darkmagenta', bg='lightcyan')\
            .grid(row=6, column=1, columnspan=1, sticky=E+W) 

        self.text_city = tk.StringVar()
        self.label_city = tk.Label(text='city', font='Verdana 18', bg='cyan', fg='darkblue')\
            .grid(row=7, column=0, sticky=E)
        self.entry_city_type = tk.Entry(width=self.WIGHT_ENTRY, font=(self.font_style, self.font_size), textvariable=self.text_city, fg='darkmagenta', bg='lightcyan')\
            .grid(row=7, column=1, columnspan=1, sticky=E+W) 

        self.text_street = tk.StringVar()
        self.label_street = tk.Label(text='street', font='Verdana 18', bg='cyan', fg='darkblue')\
            .grid(row=8, column=0, sticky=E)
        self.entry_street = tk.Entry(width=self.WIGHT_ENTRY, font=(self.font_style, self.font_size), textvariable=self.text_street, fg='darkmagenta', bg='lightcyan')\
            .grid(row=8, column=1, columnspan=1, sticky=E+W) 

        self.text_street_type = tk.StringVar()
        self.label_street_type = tk.Label(text='street_type', font='Verdana 18', bg='cyan', fg='darkblue')\
            .grid(row=9, column=0, sticky=E)
        self.entry_street_type = tk.Entry(width=self.WIGHT_ENTRY, font=(self.font_style, self.font_size), textvariable=self.text_street_type, fg='darkmagenta', bg='lightcyan')\
            .grid(row=9, column=1, columnspan=1, sticky=E+W) 

        self.text_hous = tk.StringVar()
        self.label_hous = tk.Label(text='hous', font='Verdana 18', bg='cyan', fg='darkblue')\
            .grid(row=10, column=0, sticky=E)
        self.entry_hous = tk.Entry(width=self.WIGHT_ENTRY, font=(self.font_style, self.font_size), textvariable=self.text_hous, fg='darkmagenta', bg='lightcyan')\
            .grid(row=10, column=1, columnspan=1, sticky=E+W) 

        self.text_post_index = tk.StringVar()
        self.label_post_index = tk.Label(text='post_index', font='Verdana 18', bg='cyan', fg='darkblue')\
            .grid(row=11, column=0, sticky=E)
        self.entry_post_index = tk.Entry(width=self.WIGHT_ENTRY, font=(self.font_style, self.font_size), textvariable=self.text_post_index, fg='darkmagenta', bg='lightcyan')\
            .grid(row=11, column=1, columnspan=1, sticky=E+W) 

        self.text_partner = tk.StringVar()
        self.label_partner = tk.Label(text='partner', font='Verdana 18', bg='cyan', fg='darkblue')\
            .grid(row=12, column=0, sticky=E)
        self.entry_partner = tk.Entry(width=self.WIGHT_ENTRY, font=(self.font_style, self.font_size), textvariable=self.text_partner, fg='darkmagenta', bg='lightcyan')\
            .grid(row=12, column=1, columnspan=1, sticky=E+W) 

        self.text_status = tk.StringVar()
        self.label_status = tk.Label(text='status', font='Verdana 18', bg='cyan', fg='darkblue')\
            .grid(row=13, column=0, sticky=E)
        self.entry_status = tk.Entry(width=self.WIGHT_ENTRY, font=(self.font_style, self.font_size), textvariable=self.text_status, fg='darkmagenta', bg='lightcyan')\
            .grid(row=13, column=1, columnspan=1, sticky=E+W) 

        self.text_register = tk.StringVar()
        self.label_register = tk.Label(text='register', font='Verdana 18', bg='cyan', fg='darkblue')\
            .grid(row=14, column=0, sticky=E)
        self.entry_register = tk.Entry(width=self.WIGHT_ENTRY, font=(self.font_style, self.font_size), textvariable=self.text_register, fg='darkmagenta', bg='lightcyan')\
            .grid(row=14, column=1, columnspan=1, sticky=E+W) 

        self.text_edrpou = tk.StringVar()
        self.label_edrpou = tk.Label(text='edrpou', font='Verdana 18', bg='cyan', fg='darkblue')\
            .grid(row=15, column=0, sticky=E)
        self.entry_edrpou = tk.Entry(width=self.WIGHT_ENTRY, font=(self.font_style, self.font_size), textvariable=self.text_edrpou, fg='darkmagenta', bg='lightcyan')\
            .grid(row=15, column=1, columnspan=1, sticky=E+W) 

        self.text_address = tk.StringVar()
        self.label_address = tk.Label(text='address', font='Verdana 18', bg='cyan', fg='darkblue')\
            .grid(row=16, column=0, sticky=E)
        self.entry_address = tk.Entry(width=self.WIGHT_ENTRY, font=(self.font_style, self.font_size), textvariable=self.text_address, fg='darkmagenta', bg='lightcyan')\
            .grid(row=16, column=1, columnspan=4, sticky=E+W) 

        #______________________________________

        self.text_partner_name = tk.StringVar()
        self.label_partner_name = tk.Label(text='partner_name', font='Verdana 18', bg='cyan', fg='darkblue')\
            .grid(row=2, column=2, sticky=E)
        self.entry_partner_name = tk.Entry(width=self.WIGHT_ENTRY, font=(self.font_style, self.font_size), textvariable=self.text_partner_name, fg='darkmagenta', bg='lightcyan')\
            .grid(row=2, column=3, columnspan=1, sticky=E+W) 

        self.text_id_terminal = tk.StringVar()
        self.label_id_terminal = tk.Label(text='id_terminal', font='Verdana 18', bg='cyan', fg='darkblue')\
            .grid(row=3, column=2, sticky=E)
        self.entry_id_terminal = tk.Entry(width=self.WIGHT_ENTRY, font=(self.font_style, self.font_size), textvariable=self.text_id_terminal, fg='darkmagenta', bg='lightcyan')\
            .grid(row=3, column=3, columnspan=1, sticky=E+W) 

        self.text_koatu = tk.StringVar()
        self.label_koatu = tk.Label(text='koatu', font='Verdana 18', bg='cyan', fg='darkblue')\
            .grid(row=4, column=2, sticky=E)
        self.entry_koatu = tk.Entry(width=self.WIGHT_ENTRY, font=(self.font_style, self.font_size), textvariable=self.text_koatu, fg='darkmagenta', bg='lightcyan')\
            .grid(row=4, column=3, columnspan=1, sticky=E+W) 

        self.text_tax_id = tk.StringVar()
        self.label_tax_id = tk.Label(text='tax_id', font='Verdana 18', bg='cyan', fg='darkblue')\
            .grid(row=5, column=2, sticky=E)
        self.entry_tax_id = tk.Entry(width=self.WIGHT_ENTRY, font=(self.font_style, self.font_size), textvariable=self.text_tax_id, fg='darkmagenta', bg='lightcyan')\
            .grid(row=5, column=3, columnspan=1, sticky=E+W) 

        self.text_koatu2 = tk.StringVar()
        self.label_koatu2 = tk.Label(text='koatu2', font='Verdana 18', bg='cyan', fg='darkblue')\
            .grid(row=6, column=2, sticky=E)
        self.entry_koatu2 = tk.Entry(width=self.WIGHT_ENTRY, font=(self.font_style, self.font_size), textvariable=self.text_koatu2, fg='darkmagenta', bg='lightcyan')\
        ...
        self.bigfont = font.Font(family="Helvetica",size=18)
        ...
        self.label_combo_city_type = tk.Label(text='city_type', font='Verdana 18', bg='cyan', fg='darkblue')\
        ...
        self.label_combo_streeet_type = tk.Label(text='street_type', font='Verdana 18', bg='cyan', fg='darkblue')\
        ...
        self.label_combo_partner = tk.Label(text='partner', font='Verdana 18', bg='cyan', fg='darkblue')\
...
#____________________________
        ...
        self.button_add = tk.Button(text="сохрани", command=self.edit_add, bg='cyan', fg='darkblue')
        self.button_add.grid(row=1, column=3)
        self.button_add['font'] = self.buttonFont

        self.button_add2 = tk.Button(text="сохрани", command=self.edit_add, bg='cyan', fg='darkblue')
        ...
        self.button_delete = tk.Button(text="удали", command=self.edit_delete, bg='cyan', fg='magenta')
